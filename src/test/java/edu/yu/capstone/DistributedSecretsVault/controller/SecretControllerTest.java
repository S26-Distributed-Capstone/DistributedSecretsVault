...
public class SecretControllerTest {
    ...
    public void testGetSecret() throws Exception {
        when(getSecretService.execute(eq("user1"), eq("sec1"), eq(1L)))
    ...
    public void testGetSecretWithoutVersion() throws Exception {
        when(getSecretService.execute(eq("user1"), eq("sec1"), eq(null)))
    ...
    public void testGetAllSecrets() throws Exception {
        when(getSecretService.executeAll(eq("user1"), eq("sec1")))
